#ifndef ADAFRUIT_ITSYBITSY_5V_CONFIG_H
#define ADAFRUIT_ITSYBITSY_5V_CONFIG_H

// This is the configuration for the Adafruit ItsyBitsy (5V) development board.
...
#endif /* ADAFRUIT_ITSYBITSY_5V_CONFIG_H */
