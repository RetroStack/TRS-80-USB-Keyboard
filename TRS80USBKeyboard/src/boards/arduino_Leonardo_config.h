#ifndef ARDUINO_LEONARDO_CONFIG_H
#define ARDUINO_LEONARDO_CONFIG_H

// This is the configuration for the Arduino Leonardo development board.
...
#endif /* ARDUINO_LEONARDO_CONFIG_H */
